...
export const howToSteps = [
  {
    step: 1,
    title: "Create Your Base Map",
    description: "Generate a vector base map, or upload a map screenshot to trace and edit.",
    image: "/landing-images/howto/how-to-1.jpg",
  },
  {
    step: 2,
    title: "Mark Points of Interest",
    description: "Label places you care about — cafés, routes, landmarks, or favorite spots.",
    image: "/landing-images/howto/how-to-2.jpg",
  },
  {
    step: 3,
    title: "Generate POI Illustrations",
    description: "Upload photos and use AI to turn points of interest into custom illustrations.",
    image: "/landing-images/howto/how-to-3.jpg",
  },
  {
    step: 4,
    title: "Customize & Export for Print",
    description: "Add assets, labels, and titles. Export high-quality files ready for printing.",
    image: "/landing-images/howto/how-to-4.jpg",
  },
];
